...
const MePage: React.FC = () => {
    ...
    return (
        <div className="w-screen h-screen relative bg-[#F2FFDA] overflow-hidden">
            ...
            <a className="w-28 left-[858px] top-[912px] absolute text-justify justify-start text-zinc-950 text-2xl font-medium inter-font" href="https://mail.google.com/mail/?view=cm&fs=1&to=suhaani2301@gmail.com" target="_blank" rel="noopener noreferrer">GMAIL</a>
            <a className="w-32 left-[1079px] top-[912px] absolute text-justify justify-start text-zinc-950 text-2xl font-medium inter-font" href="https://www.behance.net/suhaaninigam" target="_blank" rel="noopener noreferrer">BEHANCE</a>
            <a className="w-32 left-[1326px] top-[912px] absolute text-justify justify-start text-zinc-950 text-2xl font-medium inter-font" href="https://www.linkedin.com/in/suhaaninigam/" target="_blank" rel="noopener noreferrer">LINKEDIN</a>
            <a className="w-36 left-[1572px] top-[912px] absolute text-justify justify-start text-zinc-950 text-2xl font-medium inter-font" href="https://www.instagram.com/suhaani.ii/" target="_blank" rel="noopener noreferrer">INSTAGRAM</a>
