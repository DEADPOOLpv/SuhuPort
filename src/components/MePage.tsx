...
const MePage: React.FC = () => {
    ...
    return (
        <div className="w-full h-full fixed inset-0 bg-[#F2FFDA] overflow-hidden p-10">
            ...
            <div className="w-[58.165rem] h-[58.165rem] left-[2.591875rem] top-[1rem] absolute origin-top-left rotate-[5.58deg]">
            ...
            <img className="w-[58.165rem] h-[58.165rem] left-[2.591875rem] top-[0.01rem] absolute origin-top-left rotate-[5.58deg]" src="/assets/me.svg" alt="Profile illustration" />
            
            <div className="w-[53.875rem] left-[53.625rem] top-[18.5rem] absolute text-justify justify-start text-zinc-950 text-[25px] font-extralight inter-font">
            ...
            <a className="w-28 left-[53.625rem] inset-x-0 bottom-0 mb-10 absolute text-justify justify-start text-zinc-950 text-[25px] font-medium inter-font" href="mailto:suhaani2301@gmail.com" target="_blank" rel="noopener noreferrer">GMAIL</a>
            ...
            <a className="left-[53.1875rem] top-[10.5rem] absolute text-justify justify-start text-zinc-950 text-[50px] font-extrabold inter-font uppercase tracking-[0.45em]">Hi&nbsp;&nbsp;&nbsp; I'm&nbsp;&nbsp;&nbsp; Suhaani</a>
            ...
            >
                <div className="absolute inset-x-0 top-[2.875rem] flex flex-col items-center">
                    ...
                    <p className="w-36 h-7 text-center text-[#070307] text-[20px] font-semibold lexend-exa lowercase -mt-2">HOME</p>
                </div>
            </button>
        </div>
    );
